---
title: 分词与Embedding：从文本到向量的两个关键步骤
sidebar_label: 分词与Embedding
date: 2025-11-23
last_update:
  date: 2025-11-23
...
```mermaid
graph LR
    A[文本: I love AI] -->|分词器 Tokenizer| B[Token IDs: 40, 256, 1024]
    B -->|查表 Lookup| C[Embedding矩阵<br/>vocab_size × hidden_dim]
    C -->|映射| D[语义向量序列<br/>3 × 768维]
    D -->|输入| E[Transformer层]
